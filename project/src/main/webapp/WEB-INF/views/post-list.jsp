          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <img class="d-block img-fluid" src="http://placehold.it/900x350" width="1200" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="http://placehold.it/900x350" width="1200" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="http://placehold.it/900x350" width="1200" alt="Third slide">
              </div>
            </div>
		  ...
		  <c:forEach var="post" items="${posts}">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                <a href="detail?id=${post.id}"><img class="card-img-top" src="${post.imagePath}" alt=""></a>
                <div class="card-body">
                  <h4 class="card-title">
